...
namespace MVCProject.Controllers
{
    public class BookModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,Author,Price,Category,PublicationYear,Stock")] BookModel bookModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,Author,Price,Category")] BookModel bookModel)
        {
